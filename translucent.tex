...
In this review I present a number of techniques for interpreting machine learning models at the level of the system, the variable and the individual prediction as well as methods for handling non-independent data.
