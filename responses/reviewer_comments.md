...
_Thanks, I have added this reference_
...
_I have given descriptions for these terms in a new paragraph (lines xx - xx). I would like to avoid an entire extra box with lots of definitions if they are not being used much in the main text._
...
_I have briefly mentioned this is the figure caption and have added a paragraph on extrapolation (lines xx-xx). there was already a small paragraph in the future directions section on combining mechanistic and machine learning models._
...
_I agree and have rewritten the text to reflect this (lines xx).
...
_Than you, I have added these references._
...
_I agree that the bar for language should be high. Thank you for all the useful suggestions below._
...
_I have reorganised the first paragraph of this section to start with a clear description of the problem before leading into the data._
...
_I have added a subsection Software with a short description of the software used and other software available for R and python._
